...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Moor runner", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Moor runner", null, 640, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Moor runner";
		app.meta["name"] = "Moor runner";
